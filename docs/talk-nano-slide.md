...
Close: *10M params, zero tokens, human pace; the 12B finds longer words at 1000x the compute.* Fund V line: frontier open model as teacher, tiny student that acts at reflex speed on the edge, measured against people (`docs/nanoagent-handoff.md` for the prior-work table). Figures and the full train/inference walk-through: `nano/lab_notebook.html`.
